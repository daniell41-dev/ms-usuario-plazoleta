...
class JwtTokenProviderTest {
    ...
    void generarToken_cuandoSeProporcionanDatosValidos_devuelveTokenNoNulo() {
        String token = jwtTokenProvider.generarToken(1L, "juan@correo.com", "EMPLEADO");
    ...
    void extraerRol_cuandoTokenEsValido_devuelveRolCorrecto() {
        ...
        assertEquals("EMPLEADO", jwtTokenProvider.extraerRol(token));
    }
    ...
    void validarToken_cuandoTokenEstaExpirado_devuelveFalse() {
        ...
        String tokenExpirado = jwtTokenProvider.generarToken(1L, "juan@correo.com", "EMPLEADO");
    ...
    void validarToken_cuandoTokenEstaFirmadoConOtroSecret_devuelveFalse() {
        ...
        String tokenAjeno = otroProvider.generarToken(1L, "juan@correo.com", "EMPLEADO");

        assertFalse(jwtTokenProvider.validarToken(tokenAjeno));
    }
}
